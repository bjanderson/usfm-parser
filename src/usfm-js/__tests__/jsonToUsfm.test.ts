...
describe('JSON to USFM', () => {
  ...
  it('process tw word attributes and spans', () => {
    generateTest('tw_words', {
      ignore: ['content-source'],
      mileStoneIgnore: ['content-source'],
      words: true,
    });
  });

  it('process tw word attributes and spans chunked', () => {
    generateTest('tw_words_chunk', {
      chunk: true,
      ignore: ['content-source'],
      mileStoneIgnore: ['content-source'],
      words: true,
  ...
  it('handles Tit 1:1 alignment', () => {
    generateTest('tit1-1_alignment', {
      chunk: true,
      mileStoneIgnore: ['lemma', 'morph'],
      mileStoneMap: { content: 'ugnt' },
      zaln: true,
    });
  });
  ...
  it('process usfm-body-testF-paragraph-whitespace', () => {
    generateTest('usfm-body-testF-paragraph-whitespace', {}, 'usfm-body-testF-paragraph-newline');
  });
